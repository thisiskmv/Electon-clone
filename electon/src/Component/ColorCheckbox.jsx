  ...
  return (
    <Box>
      <Box className="detail_page_main_container">
        <Box className="detail_page_first_container">
          ...
          <Box className="product_detail_container">
            ...
            <Box className="reviews_div">
              <span>
                <AiOutlineStar size={'25px'} color="#eda515" /> <AiOutlineStar size={'25px'} color="#eda515" />{' '}
                <AiOutlineStar size={'25px'} color="#eda515" /> <AiOutlineStar size={'25px'} color="#eda515" />{' '}
                <AiOutlineStar size={'25px'} color="#eda515" />
              </span>
              <p>No reviews</p>
            </Box>
            ...
            <Box className="product_color_div">
              <h3>
                Color:{' '}
                <span>
                  <AiTwotoneCheckCircle color="black" size={'20px'} />
                </span>
                <span>
                  <AiTwotoneCheckCircle color="red" size={'20px'} />
                </span>
                <span>
                  <AiTwotoneCheckCircle color="yellow" size={'20px'} />
                </span>
              </h3>
            </Box>
            <Box className="product_size_div">
              <h3>
                Size: <span>30</span> <span>40</span> <span>50</span> <span>60</span>
              </h3>
            </Box>
            <Box className="product_quantity_div">
              <h3>
                Quntity: <Button>-</Button><span>2</span> <Button>+</Button>
              </h3>
            </Box>
        ...
        <Box className="detail_page_second_container"></Box>
        <Box className="detail_page_third_container"></Box>
      </Box>
    </Box>
  );
}
